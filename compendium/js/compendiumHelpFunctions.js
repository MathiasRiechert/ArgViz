...
helpIndex.table = [
    ...
    ["1.Ueberblickstabelle.html", "c", "Dargestellte Inhalte"],
    ["1.2.Alternativen.html", "c","Alternativen"],
    ["3.Statuscodierung.html", "r","Status&shy;kodierung"],
    ["2.Definitionskatalog.html", "r", "Definitionen anzeigen"],
...
function endTutorial(activeVisualization) {
   ...
   var linkURL = "";
            ...
            window.location.replace(linkURL+"&urlimport=1&questlist=treatment;treatment2;prototype_time;prototype_tutorial_time&treatment=4&treatment2="+surveyTreatment2+"&w="+surveypw+"&prototype_tutorial_time="+prototype_tutorial_time+"&prototype_time=" +prototype_time+ "&p=" + surveyUserId);  });           
   ...
   $(".surveybutton").on("click", function(d){ 
    ...
    // window.location.replace("https://na1.se.voxco.com/A4Survey.SurveyEngine/?st=pOw6Pcq8eMBFp%2fCX%2fcR%2f8jJieIPcIpZ%2fGIx%2bQXIPvPE%3d&urlimport=1&questlist=treatment;prototype_time;prototype_tutorial_time&treatment=2&w="+surveypw+"&prototype_tutorial_time="+prototype_tutorial_time+"&prototype_time=" +prototype_time+ "&p=" + surveyUserId);  });           
     var linkURL = "";
            ...
            window.location.replace(linkURL+"&urlimport=1&questlist=treatment;treatment2;prototype_time;prototype_tutorial_time&treatment=4&treatment2="+surveyTreatment2+"&w=KDSFp99x&prototype_tutorial_time="+prototype_tutorial_time+"&prototype_time=" +prototype_time+ "&p=" + surveyUserId); 
        }); 
      if (tutorialmode==1)
       {     
