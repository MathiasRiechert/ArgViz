...
helpIndex.table = [
    ...
    ["1.Ueberblickstabelle.html", "c", "Überblickstabelle"],
    ["2.Definitionskatalog.html", "c", "Definitionskatalog"],
    ["3.Statuscodierung.html", "r","Statuskodierung"],
...
function endTutorial(activeVisualization) {
    ...
    var linkURL = "";
            ...
            window.location.replace(linkURL+"&urlimport=1&questlist=treatment;treatment2;prototype_time;prototype_tutorial_time&treatment=7&treatment2="+surveyTreatment2+"&w="+surveypw+"&prototype_tutorial_time="+prototype_tutorial_time+"&prototype_time=" +prototype_time+ "&p=" + surveyUserId);  });           
